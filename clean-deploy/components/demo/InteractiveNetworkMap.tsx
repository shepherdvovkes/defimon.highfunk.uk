...
const InteractiveNetworkMap = () => {
  ...
  // Enhanced network topology data with real protocols - WIDER SPACING
  const [networkNodes, setNetworkNodes] = useState<NetworkNode[]>([
    // Ethereum Mainnet Validators
    { id: 'eth-validator-1', name: 'ETH Validator #1', type: 'validator', x: 150, y: 120, z: 0, region: 'North America', country: 'USA', connections: ['eth-rpc-1', 'eth-bridge-1'], status: 'online', latency: 45, bandwidth: 1000, uptime: 99.9, color: '#627EEA', size: 80, dataFlow: 1250, lastUpdate: new Date() },
    { id: 'eth-validator-2', name: 'ETH Validator #2', type: 'validator', x: 800, y: 180, z: 0, region: 'Europe', country: 'Germany', connections: ['eth-rpc-2', 'eth-bridge-2'], status: 'online', latency: 52, bandwidth: 950, uptime: 99.8, color: '#627EEA', size: 75, dataFlow: 1180, lastUpdate: new Date() },
    { id: 'eth-validator-3', name: 'ETH Validator #3', type: 'validator', x: 1450, y: 150, z: 0, region: 'Asia', country: 'Singapore', connections: ['eth-rpc-3', 'eth-bridge-3'], status: 'online', latency: 38, bandwidth: 1100, uptime: 99.7, color: '#627EEA', size: 70, dataFlow: 1320, lastUpdate: new Date() },
    
    // RPC Nodes
    { id: 'eth-rpc-1', name: 'ETH RPC #1', type: 'rpc', x: 300, y: 250, z: 0, region: 'North America', country: 'USA', connections: ['eth-validator-1', 'arb-rpc-1'], status: 'online', latency: 28, bandwidth: 2000, uptime: 99.9, color: '#96BEDC', size: 60, dataFlow: 2100, lastUpdate: new Date() },
    { id: 'eth-rpc-2', name: 'ETH RPC #2', type: 'rpc', x: 950, y: 300, z: 0, region: 'Europe', country: 'Netherlands', connections: ['eth-validator-2', 'opt-rpc-1'], status: 'online', latency: 35, bandwidth: 1800, uptime: 99.8, color: '#96BEDC', size: 65, dataFlow: 1950, lastUpdate: new Date() },
    { id: 'arb-rpc-1', name: 'ARB RPC #1', type: 'rpc', x: 450, y: 200, z: 0, region: 'North America', country: 'USA', connections: ['eth-rpc-1', 'arb-bridge-1'], status: 'online', latency: 22, bandwidth: 2500, uptime: 99.9, color: '#FF0420', size: 70, dataFlow: 2400, lastUpdate: new Date() },
    { id: 'opt-rpc-1', name: 'OPT RPC #1', type: 'rpc', x: 1100, y: 280, z: 0, region: 'Europe', country: 'UK', connections: ['eth-rpc-2', 'opt-bridge-1'], status: 'online', latency: 31, bandwidth: 2200, uptime: 99.7, color: '#FF0420', size: 68, dataFlow: 2250, lastUpdate: new Date() },
    
    // Bridge Nodes
    { id: 'eth-bridge-1', name: 'ETH Bridge #1', type: 'bridge', x: 200, y: 350, z: 0, region: 'North America', country: 'USA', connections: ['eth-validator-1', 'arb-bridge-1', 'poly-bridge-1'], status: 'online', latency: 15, bandwidth: 1500, uptime: 99.9, color: '#8247E5', size: 85, dataFlow: 1600, lastUpdate: new Date() },
    { id: 'arb-bridge-1', name: 'ARB Bridge #1', type: 'bridge', x: 550, y: 320, z: 0, region: 'North America', country: 'USA', connections: ['arb-rpc-1', 'eth-bridge-1'], status: 'online', latency: 12, bandwidth: 1800, uptime: 99.8, color: '#8247E5', size: 90, dataFlow: 1850, lastUpdate: new Date() },
    { id: 'poly-bridge-1', name: 'POLY Bridge #1', type: 'bridge', x: 1300, y: 400, z: 0, region: 'Asia', country: 'India', connections: ['eth-bridge-1', 'poly-rpc-1'], status: 'degraded', latency: 85, bandwidth: 800, uptime: 98.5, color: '#8247E5', size: 75, dataFlow: 750, lastUpdate: new Date() },
    
    // DEX Nodes
    { id: 'uniswap-node', name: 'Uniswap V3', type: 'dex', x: 700, y: 450, z: 0, region: 'North America', country: 'USA', connections: ['eth-rpc-1', 'arb-rpc-1'], status: 'online', latency: 18, bandwidth: 3000, uptime: 99.9, color: '#FF007A', size: 100, dataFlow: 3200, lastUpdate: new Date() },
    { id: 'sushiswap-node', name: 'SushiSwap', type: 'dex', x: 1200, y: 500, z: 0, region: 'Europe', country: 'Switzerland', connections: ['eth-rpc-2', 'opt-rpc-1'], status: 'online', latency: 25, bandwidth: 2800, uptime: 99.8, color: '#FF007A', size: 95, dataFlow: 2950, lastUpdate: new Date() },
    
    // Oracle Nodes
    { id: 'chainlink-node', name: 'Chainlink Oracle', type: 'oracle', x: 900, y: 380, z: 0, region: 'North America', country: 'USA', connections: ['eth-rpc-1', 'arb-rpc-1', 'opt-rpc-1'], status: 'online', latency: 20, bandwidth: 2500, uptime: 99.9, color: '#2A5ADA', size: 110, dataFlow: 2600, lastUpdate: new Date() },
    
    // Additional nodes for geographic distribution
    { id: 'cosmos-validator', name: 'Cosmos Validator', type: 'validator', x: 100, y: 550, z: 0, region: 'Europe', country: 'France', connections: ['cosmos-rpc'], status: 'online', latency: 42, bandwidth: 1200, uptime: 99.7, color: '#2E3148', size: 70, dataFlow: 1250, lastUpdate: new Date() },
    { id: 'solana-validator', name: 'Solana Validator', type: 'validator', x: 1400, y: 600, z: 0, region: 'North America', country: 'Canada', connections: ['solana-rpc'], status: 'online', latency: 35, bandwidth: 1500, uptime: 99.6, color: '#9945FF', size: 80, dataFlow: 1550, lastUpdate: new Date() }
  ])
  ...
  const regions: NetworkRegion[] = [
    { name: 'North America', nodes: ['eth-validator-1', 'eth-rpc-1', 'arb-rpc-1', 'eth-bridge-1', 'arb-bridge-1', 'uniswap-node', 'chainlink-node'], color: '#3B82F6', center: { x: 400, y: 250 } },
    { name: 'Europe', nodes: ['eth-validator-2', 'eth-rpc-2', 'opt-rpc-1', 'sushiswap-node', 'cosmos-validator'], color: '#8B5CF6', center: { x: 900, y: 350 } },
