...
Подробная архитектурная документация находится в папке [`architecture/`](architecture/README.md):

- **Основная архитектура системы** - трехуровневая архитектура платформы
- **Торговые стратегии** - детальное описание арбитражных стратегий
- **UML диаграммы** - компоненты и функциональные схемы
- **Анализ производительности** - узкие места и оптимизации

Для быстрого доступа используйте:
- [`architecture/README.md`](architecture/README.md) - обзор всей документации
- [`architecture/architecture-complete-overleaf.zip`](architecture/architecture-complete-overleaf.zip) - полный архив для Overleaf
