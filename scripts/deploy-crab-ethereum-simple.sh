...
# DEFIMON Ethereum Full Node Setup for Crab Server
...
show_setup_summary() {
    echo ""
    print_header "Ethereum Full Node Setup Summary"
    echo "====================================="
...
# Main function
main() {
    print_header "DEFIMON Ethereum Full Node Setup for Crab Server"
    echo "====================================================="
